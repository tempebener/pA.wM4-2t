...
<div class="tab-content">
    ...
    <div id="quotes" class="tab-pane fade">
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fas fa-file-signature nb"></i><?= $product->name . ' ' . lang('quotes'); ?>
                </h2>
    ...
    <div id="transfers" class="tab-pane fade">
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fas fa-retweet nb"></i><?= $product->name . ' ' . lang('transfers'); ?>
                </h2>
