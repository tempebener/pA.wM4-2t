    ...
    $(document).ready(function () {
        ...
        function add_product_item(item) {
            ...
            $.each(items, function () {
                ...
                tr_html += '<td><input class="form-control text-center rprice" name="combo_item_price[]" type="text" value="' + formatNumber(this.price) + '" data-id="' + row_no + '" data-item="' + this.id + '" id="combo_item_price_' + row_no + '" onClick="this.select();" data-a-dec="," data-a-sep="."></td>';
            ...
            rprice.addEventListener("keyup", function(e) {
              rprice.value = formatRupiah(this.value);
            });
            // Add by Bayu
            /* Fungsi formatRupiah */
...
weight.addEventListener("keyup", function(e) {
  weight.value = formatRupiah(this.value);
});
