            ...
            <ul class="btn-tasks">
                ...
                ?>
                        ...
                        <li>
                            <a href="#" id="sync_quantity" data-action="sync_quantity">
                                <i class="fas fa-arrows-alt-v"></i> <?= lang('sync_quantity') ?>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <i class="fas fa-trash-alt"></i> <?= lang('delete_products') ?>
                             </a>
                         </li>
                    </ul>
                </li>
                ...
                ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('products') ?>"><i class="far fa-building"></i> <?= lang('all_warehouses') ?></a></li>
                            <li class="divider"></li>
                            <?php
