    ...
    <div class="site-wrapper">
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <!-- <div class="mastfoot">
                    <div class="inner">
                        <p>Stock Manager Advacne by <a href="http://wmeat.store">Tecdiary</a>.</p>
                    </div>
                </div> -->
            </div>
        </div>
