                    ...
                    <tfoot>
                        ...
                        if ($inv->paid < ($inv->grand_total )) {
                            ...
                            <tr>
                                ...
                                <th class="text-right"><?=$this->sma->formatMoney(($return_sale ? (($inv->grand_total ) + $return_sale->grand_total) : ($inv->grand_total )) - ($return_sale ? ($inv->paid + $return_sale->paid) : $inv->paid)); ?></th>
                            </tr>
                            <?php
                        } ?>
                    </tfoot>
