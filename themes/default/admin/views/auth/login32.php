    ...
    ?>
                        ...
                        <div class="col-sm-12">
                            <div class="textbox-wrap form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" value="<?= DEMO ? 'owner@wmeat.store' : ''; ?>" required="required" class="form-control" name="identity"
        ...
        <?php if (DEMO) {
            ...
            <div style="color:#fff;padding-top:30px;text-align:center;">
              <h4 style="color:#f4f5f6;font-size:18px;line-height:24px;">Check out our latest item<br>Simple Business Manager &nbsp; [ <a href="https://wmeat.store/products/simple-business-manager" target="_top" style="color:#fff;">Details</a> ] &nbsp; [ <a href="https://sbm.wmeat.store/" target="_top" style="color:#fff;">Demo</a> ]</h3>
                <a href="https://sbm.wmeat.store/" target="_top"><img src="https://tecdiary.net/images/hotlink-ok/sbm.png" alt="Simple Business Manager" style="border-radius:10px !important;max-width:100%;"></a>
            </div>
        <?php
        } ?>
