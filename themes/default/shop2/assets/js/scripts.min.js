...
function gen_html(t) { var e = ""; if (get_width() > 992) var s = get("shop_grid"),
        a = ".three-col" == s ? 4 : 6;
    else var s = ".two-col",
        a = 2; var i = s && ".three-col" == s ? "col-sm-6 col-md-3" : "col-md-6",
        o = s && ".three-col" == s ? "alt" : ""; if (t || (e += '<div class="col-sm-12"><div class="alert alert-warning text-center padding-xl margin-top-lg"><h4 class="margin-bottom-no">' + lang.x_product + "</h4></div></div>"), 1 == site.settings.products_page && ($("#results").empty(), $(".grid").isotope("destroy").isotope()), $.each(t, function(s, r) { var n = r.special_price ? r.special_price : r.price,
...
function update_cart(t) { if (t.total_items && t.total_items > 0) { $("#cart-table tbody").empty(); var e = 1;
        $.each(t.contents, function() { var t = this,
            ...
            this.options && (s += '<select name="' + e + '[option]" class="selectpicker cart-item-option" data-width="100%" data-style="btn-default">', $.each(this.options, function() { s += '<option value="' + this.id + '" ' + (this.id == t.option ? "selected" : "") + ">" + this.name + " " + (0 != parseFloat(this.price) ? "(+" + this.price + ")" : "") + "</option>" }), s += "</select>"), s += '</td>\n            <td><input type="text" name="' + e + '[qty]" class="form-control text-center input-qty cart-item-qty" value="' + this.qty + '"></td>\n            <td class="text-right">' + this.price + '</td>\n            <td class="text-right">' + this.subtotal + "</td>\n            ", e++, $('<tr id="' + this.rowid + '">' + s + "</tr>").appendTo("#cart-table tbody") }), $("#cart-totals").empty(); var s = "<tr><td>" + lang.total_w_o_tax + '</td><td class="text-right">' + t.subtotal + "</td></tr>";
...
function formatSA(t) { t = t.toString(); var e = "";
    t.indexOf(".") > 0 && (e = t.substring(t.indexOf("."), t.length)), t = Math.floor(t), t = t.toString(); var s = t.substring(t.length - 3),
        a = t.substring(0, t.length - 3); "" != a && (s = "," + s); var i = a.replace(/\B(?=(\d{2})+(?!\d))/g, ",") + s + e; return i }
...
function saa_alert(t, e, s, a) { s = s || "delete", e = e || "This action can't be reverted back.", a = a || {}, a._method = s, a[site.csrf_token] = site.csrf_token_value, swal({ title: "Are you sure?", html: e, type: "question", showCancelButton: !0, allowOutsideClick: !1, showLoaderOnConfirm: !0, preConfirm: function() { return new Promise(function() { $.ajax({ url: t, type: "POST", data: a, success: function(t) { return t.redirect ? (window.location.href = t.redirect, !1) : (t.cart && (cart = t.cart, update_mini_cart(cart), update_cart(cart)), void sa_alert(t.status, t.message)) }, error: function() { sa_alert("Error!", "Ajax call failed, please try again or contact site owner.", "error", !0) } }) }) } }).catch(swal.noop) }

function prompt(t, e, s) { t = t || "Reset Password", e = e || "Please type your email address", s = s || {}, s[site.csrf_token] = site.csrf_token_value, swal({ title: t, html: e, input: "email", showCancelButton: !0, allowOutsideClick: !1, showLoaderOnConfirm: !0, confirmButtonText: lang.submit, preConfirm: function(t) { return s.email = t, new Promise(function(t, e) { $.ajax({ url: site.base_url + "forgot_password", type: "POST", data: s, success: function(s) { s.status ? t(s) : e(s) }, error: function() { sa_alert("Error!", "Ajax call failed, please try again or contact site owner.", "error", !0) } }) }) } }).then(function(t) { sa_alert(t.status, t.message) }) }

function add_address(t) { t = t || {}; var e = ""; if (istates) { var s = document.createElement("select");
        s.id = "address-state", s.name = "state", s.className = "selectpickerstate mobile-device", s.setAttribute("data-live-search", !0), s.setAttribute("title", "State"); var a = Object.keys(istates);
        a.map(function(t) { if (0 != t) { var e = document.createElement("option");
                e.value = t, e.text = istates[t], s.appendChild(e) } }), e = s.outerHTML } else e = '<input name="state" value="' + (t.state ? t.state : "") + '" id="address-state" class="form-control" placeholder="State">';
    swal({ title: t.id ? lang.update_address : lang.add_address, html: '<span class="text-bold padding-bottom-md">' + lang.fill_form + '</span><hr class="swal2-spacer padding-bottom-xs" style="display: block;"><form action="' + site.shop_url + 'address" id="address-form" class="padding-bottom-md"><input type="hidden" name="' + site.csrf_token + '" value="' + site.csrf_token_value + '"><div class="row"><div class="form-group col-sm-12"><input name="line1" id="address-line-1" value="' + (t.line1 ? t.line1 : "") + '" class="form-control" placeholder="Line 1"></div></div><div class="row"><div class="form-group col-sm-12"><input name="line2" id="address-line-2" value="' + (t.line2 ? t.line2 : "") + '" class="form-control" placeholder="Line 2"></div></div><div class="row"><div class="form-group col-sm-6"><input name="city" value="' + (t.city ? t.city : "") + '" id="address-city" class="form-control" placeholder="City"></div><div class="form-group col-sm-6" id="istates">' + e + '</div><div class="form-group col-sm-6"><input name="postal_code" value="' + (t.postal_code ? t.postal_code : "") + '" id="address-postal-code" class="form-control" placeholder="Postal Code"></div><div class="form-group col-sm-6"><input name="country" value="' + (t.country ? t.country : "") + '" id="address-country" class="form-control" placeholder="Country"></div><div class="form-group col-sm-12 margin-bottom-no"><input name="phone" value="' + (t.phone ? t.phone : "") + '" id="address-phone" class="form-control" placeholder="Phone"></div></form></div>', showCancelButton: !0, allowOutsideClick: !1, confirmButtonText: lang.submit, preConfirm: function() { return new Promise(function(t, e) { $("#address-line-1").val() || e("Line 1 is required"), $("#address-city").val() || e("City is required"), $("#address-state").val() || e("State is required"), $("#address-country").val() || e("Country is required"), $("#address-phone").val() || e("Phone is required"), t() }) }, onOpen: function() { if ($("#address-line-1").val(t.line1 ? t.line1 : "").focus(), /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) $(".selectpickerstate").selectpicker({ modile: !0 }), $(".selectpickerstate").selectpicker("val", t.state ? t.state : "");
            else { for (var e = document.querySelectorAll(".mobile-device"), s = 0; s < e.length; s++) e[s].classList.remove("mobile-device");
                $(".selectpickerstate").selectpicker({ size: 5 }), $(".selectpickerstate").selectpicker("val", t.state ? t.state : "") } } }).then(function(e) { var s = $("#address-form");
        $.ajax({ url: s.attr("action") + (t.id ? "/" + t.id : ""), type: "POST", data: s.serialize(), success: function(t) { return t.redirect ? (window.location.href = t.redirect, !1) : void sa_alert(t.status, t.message, t.level) }, error: function() { sa_alert("Error!", "Ajax call failed, please try again or contact site owner.", "error", !0) } }) }).catch(swal.noop) }

function email_form() { swal({ title: lang.send_email_title, html: '<div><span class="text-bold padding-bottom-md">' + lang.fill_form + '</span><hr class="swal2-spacer padding-bottom-xs" style="display: block;"><form action="' + site.shop_url + 'send_message" id="message-form" class="padding-bottom-md"><input type="hidden" name="' + site.csrf_token + '" value="' + site.csrf_token_value + '"><div class="row"><div class="form-group col-sm-12"><input type="text" name="name" id="form-name" value="" class="form-control" placeholder="Full Name"></div></div><div class="row"><div class="form-group col-sm-12"><input type="email" name="email" id="form-email" value="" class="form-control" placeholder="Email"></div></div><div class="row"><div class="form-group col-sm-12"><input type="text" name="subject" id="form-subject" value="" class="form-control" placeholder="Subject"></div></div><div class="row"><div class="col-sm-12"><textarea name="message" id="form-message" class="form-control" placeholder="Message" style="height:100px;"></textarea></div></div></form></div>', showCancelButton: !0, allowOutsideClick: !1, confirmButtonText: lang.submit, preConfirm: function() { return new Promise(function(t, e) { $("#form-name").val() || e("Name is required"), $("#form-email").val() || e("Email is required"), $("#form-subject").val() || e("Subject is required"), $("#form-message").val() || e("Message is required"), validateEmail($("#form-email").val()) || e("Email is invalid"), t() }) }, onOpen: function() { $("#form-name").focus() } }).then(function(t) { var e = $("#message-form");
        $.ajax({ url: e.attr("action"), type: "POST", data: e.serialize(), success: function(t) { return t.redirect ? (window.location.href = t.redirect, !1) : void sa_alert(t.status, t.message, t.level, !0) }, error: function() { sa_alert("Error!", "Ajax call failed, please try again or contact site owner.", "error", !0) } }) }).catch(swal.noop) }

function validateEmail(t) { var e = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/; return e.test(t) } $(function() { if ($(document).on("click", ".add-to-cart", function(t) { t.preventDefault(); var e = $(this).attr("data-id"),
                s = $(".shopping-cart:visible"),
                a = $(this).parents(".product-bottom").find(".quantity-input"),
                i = $(this).parents(".product").find("img").eq(0); if (i) { var o = i.clone().offset({ top: i.offset().top, left: i.offset().left }).css({ opacity: "0.5", position: "absolute", height: "150px", width: "150px", "z-index": "1000" }).appendTo($("body")).animate({ top: s.offset().top + 10, left: s.offset().left + 10, width: "50px", height: "50px" }, 400);
                o.animate({ width: 0, height: 0 }, function() { $(this).detach() }) } $.ajax({ url: site.site_url + "cart/add/" + e, type: "GET", dataType: "json", data: { qty: a.val() } }).done(function(t) { t.error ? sa_alert("Error!", t.message, "error", !0) : (s = t, update_mini_cart(t)) }) }), $(document).on("click", ".btn-minus", function(t) { var e = $(this).parent().find("input");
            parseInt(e.val()) > 1 && e.val(parseInt(e.val()) - 1) }), $(document).on("click", ".guest-checkout", function(t) { return console.log(this), $(".nav-tabs a:last").tab("show"), !1 }), $(document).on("click", ".btn-plus", function(t) { var e = $(this).parent().find("input");
            e.val(parseInt(e.val()) + 1) }), $(document).on("click", ".add-to-wishlist", function(t) { t.preventDefault(); var e = $(this).attr("data-id");
            $.ajax({ url: site.site_url + "cart/add_wishlist/" + e, type: "GET", dataType: "json" }).done(function(t) { if (t.total) $("#total-wishlist").text(t.total);
                else if (t.redirect) return window.location.href = t.redirect, !1;
                sa_alert(t.status, t.message, t.level) }) }), $(document).on("click", ".remove-wishlist", function(t) { t.preventDefault(); var e = $(this),
                s = $(this).attr("data-id");
            $.ajax({ url: site.site_url + "cart/remove_wishlist/" + s, type: "GET", dataType: "json" }).done(function(t) { if (0 == t.total) setTimeout(function() { location.reload() }, 1e3);
                else if (t.redirect) return window.location.href = t.redirect, !1;
                t.status != lang.error && e.closest("tr").remove(), $("#total-wishlist").text(t.total), sa_alert(t.status, t.message, t.level) }) }), update_mini_cart(cart), $("#dropdown-cart").click(function() { $(this).next(".dropdown-menu").animate({ scrollTop: $(this).next(".dropdown-menu").height() + 400 }, 100) }), $("#add-address").click(function(t) { t.preventDefault(), add_address() }), $(".edit-address").click(function(t) { t.preventDefault(); var e = $(this).attr("data-id");
            addresses && $.each(addresses, function() { this.id == e && add_address(this) }) }), $(document).on("click", ".forgot-password", function(t) { t.preventDefault(), prompt(lang.reset_pw, lang.type_email) }), $("ul.nav li.dropdown").hover(function() { get_width() >= 767 && $(this).addClass("open") }, function() { get_width() >= 767 && $(this).removeClass("open") }), $("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(t) { t.preventDefault(), t.stopPropagation(), $(this).parent().siblings().removeClass("open"), $(this).parent().toggleClass("open") }), $(".tip").tooltip({ container: "body" }), $(".validate").formValidation({ framework: "bootstrap", message: "This value is required or not valid" }), $(window).scroll(function() { $(this).scrollTop() > 70 ? $(".back-to-top").fadeIn() : $(".back-to-top").fadeOut() }), sticky_footer(), $(window).resize(sticky_footer), sticky_con(), $(window).resize(sticky_con), /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) $(".selectpicker").selectpicker({ modile: !0 });
    else { for (var t = document.querySelectorAll(".mobile-device"), e = 0; e < t.length; e++) t[e].classList.remove("mobile-device");
        $(".selectpicker").selectpicker() } if ($(".theme-color").click(function(t) { return store("shop_color", $(this).attr("data-color")), $("#wrapper").removeAttr("class").addClass($(this).attr("data-color")), !1 }), (shop_color = get("shop_color")) && $("#wrapper").removeAttr("class").addClass(shop_color), "products" == v && ($(window).resize(function() { gen_html(products) }), 1 == site.settings.products_page && $(".grid").isotope({ itemSelector: ".grid-item" }), $("#sorting").on("changed.bs.select", function(t) { return console.log($(this).val()), store("sorting", $(this).val()), searchProducts(), !1 }), $(".two-col").click(function() { return store("shop_grid", ".two-col"), $(this).addClass("active"), $(".three-col").removeClass("active"), gen_html(products), !1 }), $(".three-col").click(function() { return store("shop_grid", ".three-col"), $(this).addClass("active"), $(".two-col").removeClass("active"), gen_html(products), !1 }), $("#product-search-form").submit(function(t) { return t.preventDefault(), filters.query = $("#product-search").val(), searchProducts(), !1 }), $("#product-search").blur(function(t) { return t.preventDefault(), filters.query = $(this).val(), searchProducts(), !1 }), $(".reset_filters_brand").click(function(t) { filters.brand = null, searchProducts(), $(this).closest("li").remove() }), $(".reset_filters_category").click(function(t) { filters.category = null, searchProducts(), $(this).closest("li").remove() }), $("#min-price, #max-price, #in-stock, #promotions, #featured").change(function() { searchProducts() }), $(document).on("click", "#pagination a", function(t) { t.preventDefault(); var e = $(this).attr("href"),
                s = e.split("page="); if (s[1]) { var a = s[1].split("&");
                filters.page = a[0] } else filters.page = 1; return searchProducts(), !1 }), (shop_grid = get("shop_grid")) && $(shop_grid).click(), (sorting = get("sorting")) ? $("#sorting").selectpicker("val", sorting) : store("sorting", "name-asc"), filters.query && $("#product-search").val(filters.query), searchProducts()), $(".product").each(function(t, e) { $(e).find(".details").hover(function() { $(this).parent().css("z-index", "20"), $(this).addClass("animate") }, function() { $(this).removeClass("animate"), $(this).parent().css("z-index", "1") }) }), "cart_ajax" == m && "index" == v) update_mini_cart(cart), update_cart(cart), $(document).on("click", ".remove-item", function(t) { t.preventDefault(); var e = {};
        e.rowid = $(this).attr("data-rowid"); var s = site.site_url + "cart/remove";
        saa_alert(s, !1, "post", e) }), $(document).on("change", ".cart-item-option, .cart-item-qty", function(t) { t.preventDefault(); var e = this.defaultValue,
            s = $(this).closest("tr"),
            a = s.attr("id"),
            i = site.site_url + "cart/update",
            o = {};
        o[site.csrf_token] = site.csrf_token_value, o.rowid = a, o.qty = s.find(".cart-item-qty").val(), o.option = s.find(".cart-item-option").children("option:selected").val(), update_cart_item(i, o, e, $(this), t.target.type) }), $(".cart-item-option").on("shown.bs.select", function(t) { $(this).children("option:selected").val() && ($po = $(this).children("option:selected").val()) }), $("#empty-cart").click(function(t) { t.preventDefault(); var e = $(this).attr("href");
        saa_alert(e) });
    else if ("shop" == m && "product" == v) { var s = $("#lightbox");
        $('[data-target="#lightbox"]').on("click", function(t) { var e = $(this).find("img"),
                a = e.attr("src"),
                i = e.attr("alt"),
                o = { maxWidth: $(window).width() - 10, maxHeight: $(window).height() - 10 };
            s.find(".close").addClass("hidden"), s.find("img").attr("src", a), s.find("img").attr("alt", i), s.find("img").css(o), s.find(".modal-content").removeClass("swal2-hide").addClass("swal2-show") }), s.on("shown.bs.modal", function(t) { var e = s.find("img");
            s.find(".modal-dialog").css({ width: e.width() }), s.find(".close").removeClass("hidden"), s.addClass("fade"), $(".modal-backdrop").addClass("fade") }), s.on("hide.bs.modal", function() { s.find(".modal-content").removeClass("swal2-show").addClass("swal2-hide") }), s.on("hidden.bs.modal", function() { s.removeClass("fade"), $(".modal-backdrop").removeClass("fade") }) } var a = document.location.toString();
...
submit_btn && (submit_btn.style.display = "none"), Array.prototype.forEach.call(inputs, function(t) { var e = t.nextElementSibling,
        s = e.innerHTML;
    t.addEventListener("change", function(t) { var a = "";
