...
$lang['csv_update_tip']                     = 'System will check if the email belong to any supplier then will update that supplier otherwise will add new supplier. If the email address already exist for WAgent/customer it will be ignored.';
