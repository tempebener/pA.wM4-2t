...
class Returns extends MY_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == true && $this->returns_model->addReturn($data, $products)) {
            ...
            $bc                       = [['link' => base_url(), 'page' => lang('home')], ['link' => admin_url('returns'), 'page' => lang('return_sales')], ['link' => '#', 'page' => lang('add_return_sales')]];
            $meta                     = ['page_title' => lang('add_return_sales'), 'bc' => $bc];
    ...
    public function index($warehouse_id = null)
    {
        ...
        $bc   = [['link' => base_url(), 'page' => lang('home')], ['link' => '#', 'page' => lang('list_return_sales')]];
        $meta = ['page_title' => lang('list_return_sales'), 'bc' => $bc];
