...
class Products extends MY_Controller
{
    ...
    public function add($id = null)
    {
        ...
        $this->form_validation->set_rules('weight', lang('weight'), 'numeric2');
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data     = [
                ...
                'cost'              => $this->sma->formatDecimal(str_replace('.', '', $this->input->post('cost'))),
                'price'             => $this->sma->formatDecimal(str_replace('.', '', $this->input->post('price'))),
                ...
                'supplier1price'    => $this->sma->formatDecimal(str_replace('.', '', $this->input->post('supplier_price'))),
                'supplier2'         => $this->input->post('supplier_2'),
                'supplier2price'    => $this->sma->formatDecimal(str_replace('.', '', $this->input->post('supplier_2_price'))),
                'supplier3'         => $this->input->post('supplier_3'),
                'supplier3price'    => $this->sma->formatDecimal(str_replace('.', '', $this->input->post('supplier_3_price'))),
                'supplier4'         => $this->input->post('supplier_4'),
                'supplier4price'    => $this->sma->formatDecimal(str_replace('.', '', $this->input->post('supplier_4_price'))),
                'supplier5'         => $this->input->post('supplier_5'),
                'supplier5price'    => $this->sma->formatDecimal(str_replace('.', '', $this->input->post('supplier_5_price'))),
                ...
                'promo_price'       => $this->sma->formatDecimal(str_replace('.', '', $this->input->post('promo_price'))),
                ...
                for ($r = 0; $r <= $c; $r++) {
                    if (isset($_POST['combo_item_code'][$r]) && isset($_POST['combo_item_quantity'][$r]) && isset($_POST['combo_item_price'][$r])) {
                        $items[] = [
                            ...
                            'unit_price' => str_replace('.', '', $_POST['combo_item_price'][$r]),
                        ];
                    }
