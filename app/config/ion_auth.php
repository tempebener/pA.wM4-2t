 ...
 */
$config['site_title']                 = "WTouch";       // Site Title, example.com This is not more functional
$config['admin_email']                = "wmeat.shop@gmail.com"; // Admin Email, admin@example.com This is not more functional
